 ...
 *
 * Called by the CLI with process.cwd(), and by the node server bundle's
 * generated preamble with the bundle-relative project root — so the
 * bundle finds its .env no matter which directory it is started from.
