/**
 * Production e2e: one real `rsc-hono build` of examples/rsc-basic, then
 * assertions against a running `rsc-hono start` server — pages, flight
