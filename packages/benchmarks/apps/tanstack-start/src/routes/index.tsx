...
/**
 * APP_SPEC.md `/`: prerendered, zero interactive components of its own. The floor measurement — how
 * much JavaScript does the framework ship for a page whose content needs none? Prerendering is
