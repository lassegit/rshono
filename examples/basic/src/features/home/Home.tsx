  ...
  return (
    ...
    <div className="hero">
      ...
      <p className="description">
        Built on <a href="https://hono.dev">Hono</a> +{" "}
        <a href="https://rspack.dev">Rspack</a>. Under 10 dependencies.
      </p>
      ...
      <div className="features">
        <div className="feature-card">
          <h3>SSR & SSG</h3>
          <p>
            Static pages pre-rendered at build time. Dynamic pages rendered on
            demand. You choose per-route.
          </p>
        </div>
        <div className="feature-card">
          <h3>API Routes</h3>
          <p>
            Full Hono power. JSON, streaming, cookies, WebSockets. Any HTTP
            method.
          </p>
        </div>
        <div className="feature-card">
          <h3>Type-Safe</h3>
          <p>
            Loader return types flow into page component props. End-to-end
            type inference.
          </p>
        </div>
      </div>
