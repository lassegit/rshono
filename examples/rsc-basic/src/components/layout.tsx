...
export function Layout({ title = 'rsc-hono', description, children }: { title?: string; description?: string; children: ReactNode }) {
    return (
        <html lang="en">
            <head>
                <meta charSet="utf-8" />
            ...
            <body>
                ...
                <footer>
                    <p>rsc-hono — Hono + Rspack + React Server Components.</p>
                </footer>
            </body>
        </html>
    );
